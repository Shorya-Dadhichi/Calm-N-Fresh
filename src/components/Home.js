...
const Home = () => {
  return (
    <section className="pt-16 sm:pt-20 lg:pt-36 h-screen text-type">
        ...
        <section>
          <div className="flex flex-col md:flex-row justify-center items-center gap-12">
            <div className="md:w-3/6 space-y-2 md:space-y-4">
              <p id="reveal_para" className="font-medium text-primary text-md pt-6 leading-loose"><em>Welcome to Calm N Fresh</em></p>
            ...
            <div className="pt-12 sm:w-3/6 relative">
              ...
              <img src={hero_img} width="2880" height="2000" id="fade-in-image" alt="illustration" className="relative"/>
      ...
      <article className="max-w-screen-xl mx-auto px-6 md:px-12 2xl:px-6 pb-24 flex flex-col md:flex-row gap-6">
        <section className="md:w-3/6 space-y-6">
          <h3 className="font-medium text-primary text-md pt-6 leading-loose">How we work</h3>
        ...
        <section className="md:w-3/6 mt-6 space-y-6">

          <div className="flex gap-6 border border-type rounded-3xl p-6">
